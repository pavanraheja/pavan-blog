...
In the 8-week boot camp project with [GrowthX](https://www.growthx.club/), after the four weeks of deep diving in modules, we had to apply the concepts and fundamentals we learned to real-time products. We got the opportunity to create a Growth Strategy for a product from [Clear](https://cleartax.in/). (previously ClearTax). We were a group of 5 team members from varied backgrounds. Team members comprised a Founder, two PMs, a banker, and myself. We came from various backgrounds and specializations. We had to work together with a common goal to achieve a Growth roadmap for a potential tech product. 
...
The product was already at stage 1. The product has a 70% Net Promoter Score(NPS). A fantastic definition for [PMF, ](https://medium.com/evergreen-business-weekly/product-market-fit-what-it-really-means-how-to-measure-it-and-where-to-find-it-70e746be907b)which I like, is "**When people sell the product for you."**
...
- Which features got them to move to use the product immediately. 
- Which features would enable them to add additional value while using the product? 
- How willing are they to refer and recommend the product? 
...
The User and Product team's insights were a real eye-opener for the whole team. Here is a terrific [read](http://www.paulgraham.com/ds.html) from Paul Graham speaking about why attention to users should be **insanely** important.

**Understand: **

This module enabled us to provide a bird' eye view of the project. We had worked on:

- To understand the core problems the product solves.
- We defined concise, precise, and real-time ICP's. We kept them to three with broad perspectives. How the ICPs spent their time and money. 
- Total Addressable Market (TAM) calculations were one of the most vital parts. We created a bottom-up approach to get more granularity for our target market. 
- Define metrics about the expectations on the frequency of the product usage. 
...
- The periodical goals. 
- The overall Growth model. 
...
- Invoices per month. 
- Usage of features like ledgers, payment reminders, and other add-on features. 
- Age of the users on the product.
...
- Setting up reminders for essential functions for users. 
- Enabling easy actions for necessary core activities. 
- Providing add-on features to make their core functions more attractive. 
...
- Experimenting with providing additional add-on services. 
- Upsell-related products. 
- An installment payment feature. 
